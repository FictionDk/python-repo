...
from tf_5_1_data_set import FashinDataSet
...
dat = FashinDataSet()
(x_train, y_train), (x_test, y_test) = dat.load_fashion()
...
history = tf_utils.model_train(model, "Inception10-Fasion", x_train, y_train, x_test, y_test, batch_size=512)
